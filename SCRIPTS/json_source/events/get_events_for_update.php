...
if ($conn != false) {
	...
	$query = "SELECT event_title, event_description, event_start_date, event_end_date, event_id, event_bg_color, event_ft_color FROM " . $prefix . "_events WHERE event_title LIKE('$searchPhrase%') $order $limit";
