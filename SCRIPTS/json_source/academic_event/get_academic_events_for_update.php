...
if ($conn != false) {
	...
	$query = "SELECT acad_title, acad_description, acad_start_date, acad_end_date, acad_id, acad_bg_color, acad_ft_color FROM " . $prefix . "_academicevents WHERE acad_title LIKE('$searchPhrase%') $order $limit";
