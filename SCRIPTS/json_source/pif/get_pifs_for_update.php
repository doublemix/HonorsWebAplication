...
if ($conn != false) {
	...
	$query = "SELECT pif_title, pif_description, pif_start_date, pif_end_date, pif_id, pif_bg_color, pif_ft_color FROM " . $prefix . "_pif WHERE pif_title LIKE('$searchPhrase%') $order $limit";
	...
	$query = "SELECT pif_id FROM " . $prefix . "_pif WHERE pif_title LIKE('$searchPhrase%')";
