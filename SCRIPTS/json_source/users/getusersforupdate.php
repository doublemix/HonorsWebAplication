...
if ($conn != false) {
	...
	$query = "SELECT usr_fname, usr_lname, usr_perm_email, usr_status, usr_education, usr_id, usr_school_email, usr_school_id FROM users WHERE (usr_school_id LIKE('$searchPhrase%') OR usr_fname LIKE ('$searchPhrase%') OR usr_lname LIKE('$searchPhrase%') OR usr_school_email LIKE ('$searchPhrase%')) AND usr_id != 1 $order $limit";
