...
$result = mysqli_query($conn, "SELECT pfdg_report_start_date as \"fdate\", pfdg_report_id FROM " . $prefix . "_fdg_reports WHERE pfdg_id = $pfdg_id AND pfdg_report_start_date < NOW() order by pfdg_report_start_date desc");
