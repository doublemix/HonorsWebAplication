...
<div class="form-group">
  <label class="col-md-4 control-label" for="usr_username">Username:</label>  
  <div class="col-md-4">
  <input name="usr_username" class="form-control input-md" id="usr_username" required type="text" placeholder="Username">
...
<input type="hidden" name="remember_to_drink_your_ovaltine" value="1"> 
