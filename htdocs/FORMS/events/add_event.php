...
<form id="event_add_form" method="post" action="#" name="eventsrequest" class="form-horizontal">

<fieldset>

<!-- Form Name -->

<legend>Add Event</legend><?php 
...
<div class="form-group">
  <label class="col-md-4 control-label" for="event_title">Title:</label>
  <div class="col-md-4">                     
      <input id="event_title" maxlength="60" class="form-control" type="text" name="event_title"></input>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea name="event_description" maxlength="200" class="form-control" id="event_description"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <div class="input-append date">
      <input id="datetimepicker" class="form-control" type="text" name="event_start_date"></input>
      <span class="add-on">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <div class="input-append date">
      <input id="datetimepickerend" type="text" name="event_end_date" class="form-control"></input>
      <span class="add-on">
        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
      </span>
    </div>
...
<input type="hidden" name="eventsrequest" value="1"/>
