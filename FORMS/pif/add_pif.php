...
<form id="pif_add_form" method="post" action="#" name="publicissuesforumrequest" class="form-horizontal">

<fieldset>

<!-- Form Name -->

<legend>Add Public Issues Forum</legend><?php 
...
<div class="form-group">
  <label class="col-md-4 control-label" for="pif_title">Title:</label>
  <div class="col-md-4">                     
      <input id="pif_title" maxlength="60" class="form-control" type="text" name="pif_title"></input>
  </div>
</div>

<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="pif_description">Description</label>
  <div class="col-md-4">                     
    <textarea name="pif_description" maxlength="250" class="form-control" id="pif_description"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <div class="input-append date">
      <input id="datetimepicker" class="form-control" type="text" name="pif_start_date"></input>
      <span class="add-on">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <div class="input-append date">
      <input id="datetimepickerend" type="text" name="pif_end_date" class="form-control"></input>
      <span class="add-on">
        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
      </span>
    </div>
...
<input type="hidden" name="publicissuesforumrequest" value="1"/>
